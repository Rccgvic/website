...
<html><!-- InstanceBegin template="/Templates/no-sidebar.dwt" codeOutsideHTMLIsLocked="false" -->
	<head>
		<title>Victory International Center</title>
	...
	<body class="no-sidebar">
			...
			<header id="header">
                ...
                <ul>
                        ...
                        <li class=""><a href="#">Connect</a>
                        	<ul>
								<li><a href="AskPastor.php">Ask the Pastor</a></li>
		...
		<!-- Main -->
        <!-- InstanceBeginEditable name="no_sidebar_image" -->
			<article id="main">
				...
				<!-- One -->
					<section class="wrapper style4 container">
						...
						<!-- Content -->
							<div class="content">
								<section><iframe src="https://calendar.google.com/calendar/embed?showTitle=0&amp;showNav=0&amp;showCalendars=0&amp;height=600&amp;wkst=1&amp;bgcolor=%23ffffff&amp;src=tadeboye%40gmail.com&amp;color=%2329527A&amp;ctz=America%2FNew_York" style="border-width:0" width="800" height="600" frameborder="0" scrolling="no"></iframe>
                                    </section>
							</div>
